...
Zatímco v předchozí kapitole jsem se zabýval popisem existujících řešení a zkoumal, jaké možnosti nabízejí současné doporučovací systémy, tato kapitola je celá věnovaná analýze požadovaného chování mnou vyvíjeného systému. Prostřednictvím výstupů získaných z této analýzy jsem následně mohl provést návrh řešení.
...
Na základě zkoumání existujících implementací v kapitole XY mě nejvíce zaujala ta open recommendatio platorm, ze které jsem se rozhodl vzít si několik principů jako multi armed bandits a tak.
