...
\emph{Pozn.} Pro výměnu dat je využíván formát JSON.
...
\begin{center}
 	\begin{tabular}{lp{10cm}}
 		...
 		\textit{Návratové kódy:}		& 200 - ok			\tabularnewline 		
 	\end{tabular}
\end{center} 	

\paragraph*{/algorithm/\{algorithm-id\}/?coreId=\{core-id\}}

Vrací seznam doporučených článků daným algoritmem.

\begin{center}
 	\begin{tabular}{lp{10cm}}
 		\textit{Metoda:}		& GET			\tabularnewline 
 		\textit{Návratové kódy:}		& 200 - ok, 400 - bad request, 404 - not found			\tabularnewline 		
 	\end{tabular}
\end{center} 
...
\begin{center}
 	\begin{tabular}{lp{10cm}}
 		...
 		\textit{Návratové kódy:}		& 201 - created, 400 - bad request, 404 - not found, 500 - server internal error			\tabularnewline 		
 	\end{tabular}
\end{center} 	

\paragraph*{/cores/\{core-id\}/documents}

Smaže z daného jádra dokument specifikovaný v těle požadavku (ID dokumentu může být obecně cokoliv, i URL, proto zasíláno v těle)

\begin{center}
 	\begin{tabular}{lp{10cm}}
 		\textit{Metoda:}		& DELETE			\tabularnewline 
 		\textit{Návratové kódy:}		& 200 - ok, 400 - bad request, 404 - not found, 500 - server internal error			\tabularnewline 		
 	\end{tabular}
\end{center} 	
...
\begin{center}
 	\begin{tabular}{lp{10cm}}
 		\textit{Metoda:}		& POST			\tabularnewline 
 		\textit{Návratové kódy:}		& 201 - created, 400 - bad request			\tabularnewline 		
 	\end{tabular}	
\end{center} 
...
\begin{center}
 	\begin{tabular}{lp{10cm}}
 		\textit{Metoda:}		& GET			\tabularnewline 
 		\textit{Návratové kódy:}		& 200 - ok, 404 - not found			\tabularnewline 		
 	\end{tabular}	
\end{center} 
...
\begin{center}
 	\begin{tabular}{lp{10cm}}
 		\textit{Metoda:}		& PUT			\tabularnewline 
 		\textit{Návratové kódy:}		& 200 - ok, 404 - not found, 400 - bad request			\tabularnewline 		
 	\end{tabular}	
\end{center} 
