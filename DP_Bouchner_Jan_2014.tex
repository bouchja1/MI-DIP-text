...
\acknowledgements{Chci upřímně poděkovat všem, kteří mi věnovali čas, když jsem potřeboval pomoc při psaní této diplomové práce. Především vedoucímu práce Ing. Jaroslavu Kuchařovi za správné směrování, cenné rady a řešení otázek, se kterými jsem se na něj obracel. Děkuji také své rodině a všem přátelům za bezvýhradnou podporu během celých mých studií.}
\abstractCS{Tato diplomová práce popisuje návrh a vývoj adaptabilního systému schopného vhodně volit a kombinovat algoritmy pro doporučování obsahu. První část práce je zasvěcena zkoumání teorie související s pokročilejšími, již existujícími systémy.

Na základě výsledků tohoto zkoumání je provedena volba vhodné učící strategie a stanovení konkrétních požadavků na systém. Druhá část práce je praktická a popisuje návrh systému, obecného rozhraní pro komunikaci, použité technologie a programátorské postupy, jakými bylo dosaženo výsledného systému. Vyvinutými částmi jsou: adaptabilní systém, sada základních algoritmů pro doporučování obsahu, RESTful API a klientská aplikace, jež na závěr umožnila provést se systémem několik experimentů. Všechny části aplikace byly implementovány v programovacím jazyce Java.}
\abstractEN{This thesis describes design and development of an adaptive system that is able to appropriately choose and combine content-recommendation algorithms. The first part of the thesis studies the theory related to advanced, already existing systems.
...
\begin{description}
  \item[Kapitola \nameref{chap:teor}] popisuje trendy používané současnými doporučovacími systémy a zkoumá algoritmické a matematické postupy, které by mohly být využity při návrhu strategie adaptabilního systému.
...
Systém jsem se snažil navrhnout co nejobecněji, aby nebyl příliš závislý na okolí a bylo možné jej snadno škálovat a přistupovat k němu prostřednictvím API. Přímo s adaptabilním jádrem je možné komunikovat jak zasíláním socketových zpráv, tak pomocí služeb REST.
...
\item[ZeroMQ, ?MQ]  Zero Message Queue
\item[MIT]  Massachusetts Institute of Technology
\item[Inc.]  Incorporation
\item[ACM]  Association for Computing Machinery
\item[RecSys]  ACM Recommender Systems
\item[ICWSM]  International Conference on Weblogs and Social Media
\item[AAAI]  Association for the Advancement of Artificial Intelligence
\item[ORP]  Open recommendation Platorm
...
\item[CQL]  Contextual Query Language
\item[JVM]  Java Virtual Machine
\item[JSON]  JavaScript Object Notation
\item[JAXRS]  Java API for RESTful Web Services
\item[MIME]  Multipurpose Internet Mail Extensions
\item[BSON]  Binary JSON
\item[PGM]  Pragmatic General Multicast
\item[XML]  Extensible Markup Language
\item[JSP]  Java Server Pages
\item[REQ/REP]  Request/Response
\item[URL]  Uniform Resource Locator
\item[URI]  Uniform Resource Identifier
\item[IMDB]  Internet Movie Database
\item[MLT]  More Like This
\end{description}
