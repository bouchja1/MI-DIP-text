...
\begin{figure}
	\dirtree{%
		...
		.1 src.
		.2 ensemble\DTcomment{zdrojové kódy implementace adaptabilního systému}.
		.2 rest\DTcomment{zdrojové kódy implementace rest rozhraní}.	
		.2 client\DTcomment{zdrojové kódy implementace testovacího klienta}.			
		.2 chef\DTcomment{skript pro nástroj chef k~instalaci prostředí}.				
