...
\subsubsection{Recommeng Application}
...
Na serverové straně se tedy nacházejí dvě hlavní komponenty:

\begin{itemize}
	\item \textbf{Recommeng Application.} Zamýšlená aplikace 
	\item \textbf{Aplikace běžící v prostředí aplikačního serveru.} 	
\end{itemize}
...
\subsubsection{Formát vyměňovaných zpráv}
